...
withdrawalSchema.statics.getAgentWithdrawalsByMonth = function(agentId, year, month) {
  return this.find({
    agent: agentId,
    withdrawalYear: year,
...
withdrawalSchema.statics.getCompletedWithdrawalsByMonth = function(agentId, year, month) {
