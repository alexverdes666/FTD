...
export const COPY_HOVER_BOX_SX = { display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 0.3 };
export const COPY_CELL_HOVER_SX = { "&:hover .copy-field-icon": { opacity: 1 } };
export const COPY_ICON_BTN_SX = { opacity: 0, transition: "opacity 0.2s", p: 0.15 };
export const COPY_ICON_SX = { fontSize: 12 };
